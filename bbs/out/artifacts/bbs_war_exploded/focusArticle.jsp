...
if (sessionState == null || sessionState == "off") {
    ...
    logState = true;
    // 添加收藏
    int msg = operation.insertollect(Integer.parseInt(sessionUserID), articleID);
    if(msg==0) focusArticle = "success";
    else focusArticle = "fail";
    
}
// 定位到指定页面
String site = new String("article.jsp?focusArticle="+focusArticle + "&articleID=" + articleID);
